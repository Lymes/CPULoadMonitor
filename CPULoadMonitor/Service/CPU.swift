...
public struct ProcessorUsage: Hashable {
...
public class CPU: NSObject {
    ...
    public static func systemUsage() -> ProcessorUsage {
        ...
        return ProcessorUsage(index: 0, user: user, system: sys, idle: idle, nice: nice)
    }
    ...
    public static func coreUsage() -> [ProcessorUsage] {
        ...
        do {
            ...
            for i in 0..<cpuCount {
                ...
                let usage = ProcessorUsage(index: Int(i), user: user, system: system, idle: idle, nice: nice)
